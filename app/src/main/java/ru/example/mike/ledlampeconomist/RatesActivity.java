...
// статически заполняем списки выборов так как никогда не меняются значения
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ru.example.mike.ledlampeconomist.R.layout.activity_rates);

        findViewById(ru.example.mike.ledlampeconomist.R.id.tableLayoutRates).setOnTouchListener(activitySwiped);



        textView = (TextView) findViewById(ru.example.mike.ledlampeconomist.R.id.textView5);

        spinnerRub = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinnerOne);
        spinnerKopeck = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinnerTwo);
        spinnerHour = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinnerHours);

        spinnerRatesTwoRub = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinner_rates_2_one);
        spinnerRatesTwoKopeck = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinner_rates_2_two);
        spinnerRatesTwoHour = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinner_rates_2_hours);
        spinnerPercent = (Spinner) findViewById(ru.example.mike.ledlampeconomist.R.id.spinner_percent);
        ...
        checked = ((CheckBox)findViewById(ru.example.mike.ledlampeconomist.R.id.checkBox)).isChecked();
...
// создаем Диалоговое окно AlertDialog для иконки ИНФО
    public void onClickInfo(View view) {
        ...
        builder.setTitle(ru.example.mike.ledlampeconomist.R.string.icon_info_title)
                .setMessage(ru.example.mike.ledlampeconomist.R.string.icon_info)
                .setIcon(ru.example.mike.ledlampeconomist.R.drawable.icon_info)
                .setCancelable(false)
                .setNegativeButton(ru.example.mike.ledlampeconomist.R.string.icon_info_close_button,
...
// создаем Диалоговое окно AlertDialog для иконки ИНФО в Тарифе 2
    public void onClickInfoRate2(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(RatesActivity.this);
        builder.setTitle(ru.example.mike.ledlampeconomist.R.string.icon_info_title)
                .setMessage(ru.example.mike.ledlampeconomist.R.string.icon_info_rate_2)
                .setIcon(ru.example.mike.ledlampeconomist.R.drawable.icon_info)
                .setCancelable(false)
                .setNegativeButton(ru.example.mike.ledlampeconomist.R.string.icon_info_close_button,
                        new DialogInterface.OnClickListener() {
